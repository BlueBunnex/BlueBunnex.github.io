const characterInfo = {
  'cacao': {
      ...
      design: "A brown wolf that is a little overweight. She has purple-yellow heterochromia, and her eye shine forms little hearts. Her hands, feet, and tail feature a bubble pattern as it transitions from brown to tan. She (typically) wears a red hoodie over a tan tee that reads ROFL across the front.",
      colors: [
          "#9c7767"
      ],
      paragraphs: [
