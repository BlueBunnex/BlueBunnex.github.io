const characterInfo = {
    'wip': {
        ...
        colors: [],
        paragraphs: [
            "She lives on the beachside, owns a small pickup, farms agales ([ə.gä.lɛɪz], a type of large berry-bearing bush that grows well in sand), and tends to some chickens, rabbits, and goats. Within each DIY wire-mesh on her property is an curious animal; Beneath every mound of soil overturned is a little seed. While this seems like an unrealistic romanticization of the countryside (which it is), she fortunately receives a pension from an unknown sender through the bank every month, so all is well.",
        ],
        table_data: {
            Species: "Shark",
            Identity: "Woman",
